...
fundecl         : func_type tID     	                              { $$ = new m19::function_declaration_node(LINE, tPRIVATE, $1, *$2, nullptr); delete $2; }
                | func_type tID qualifier                           { $$ = new m19::function_declaration_node(LINE, $3      , $1, *$2, nullptr); delete $2; }
                | func_type tID     	    args                      { $$ = new m19::function_declaration_node(LINE, tPRIVATE, $1, *$2, $3);      delete $2; }
                | func_type tID qualifier args                      { $$ = new m19::function_declaration_node(LINE, $3      , $1, *$2, $4);      delete $2; }
                ;
...
fundef			    : func_type tID 	  args             ini_sec secs end_sec	  { $$ = new m19::function_definition_node(LINE, tPRIVATE, $1, *$2, $3, $4, $5, $6); delete $2;}
                | func_type tID '!' args             ini_sec secs end_sec	  { $$ = new m19::function_definition_node(LINE, tPUBLIC,  $1, *$2, $4, $5, $6, $7); delete $2; }
                | func_type tID 	  args '=' literal ini_sec secs end_sec	  { $$ = new m19::function_definition_node(LINE, tPRIVATE, $1, *$2, $3, $5, $6, $7, $8); delete $2; }
                | func_type tID '!' args '=' literal ini_sec secs end_sec	  { $$ = new m19::function_definition_node(LINE, tPUBLIC,  $1, *$2, $4, $6, $7, $8, $9); delete $2; }
                ;

func_type       : data_type                                         { $$ = $1; }
                | '!'                                               { $$ = nullptr; }
                ;
